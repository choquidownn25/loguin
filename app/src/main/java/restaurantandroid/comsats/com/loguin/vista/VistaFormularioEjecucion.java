package restaurantandroid.comsats.com.loguin.vista;
...
import restaurantandroid.comsats.com.loguin.R;
import restaurantandroid.comsats.com.loguin.orden_servicio.Orden_Servicio;
import restaurantandroid.comsats.com.loguin.utilidad.CustomOnItemSelectedListener;

/**
 * Created by choqu_000 on 22/07/2015.
 */
public class VistaFormularioEjecucion extends Activity implements OnItemSelectedListener {
    ...
    public void onCreate(Bundle saveInstanceState){
        ...
        // Aquí Spinner se ha establecido esta clase para escuchar en cualquier
        // cambios seleccionando cualquiera de su elemento que eventualmente
        //desencadenar el método onItemSelected.
            ...
            public void onClick(View v) {
                ...
                if(!id_orden_servicio.getText().toString().trim().equalsIgnoreCase("")||
                    ...
                    if(compruebaId_Orden_Servicio())
                        new Update(VistaFormularioEjecucion.this).execute();

                    else
                        Toast.makeText(VistaFormularioEjecucion.this, "Hay información por rellenar", Toast.LENGTH_LONG).show();
            }
        });
    ...
    // Este método pueblan el ArrayList <String> y después
    ...
    //Método de devolución de llamada que se invoca cuando un elemento en este punto de vista ha sido seleccionado.
    @Override
    ...
    private boolean compruebaId_Orden_Servicio(){
        ...
        runOnUiThread(new Runnable(){
            ...
            public void run() {
                // TODO Auto-generated method stub
                Toast.makeText(VistaFormularioEjecucion.this, "El registro no existe", Toast.LENGTH_LONG).show();
            }
        });
        return false;
    }
    ...
    class  Update extends  AsyncTask<String, String, String>{
        ...
        @Override
        //Metodo   asíncrona se pasan parametros paso por paso
        protected String doInBackground(String... params) {
            if(update())
                context.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(context, "Persona actulizada con éxito",
                ...
                context.runOnUiThread(new Runnable() {
                    ...
                    public void run() { //Hilo
                        Toast.makeText(context, "Persona no actulizada con éxito",
                                Toast.LENGTH_LONG).show();
                    }
                });
            return null;
    ...
    private boolean update(){
        ...
        //Clientes HTTP encapsulan una mezcla heterogénea de objetos necesarios para ejecutar
        ...
        //El método POST se utiliza para solicitar que el servidor de origen
        ...
        //httppost= new HttpPost("http://192.168.1.124/pruebasigti/update2.php"); // Url del Servidor
        httppost= new HttpPost("http://192.168.1.195/pruebasigti/update2.php"); // Url del Servidor
